    ...
    $.ajax({
        ...
        success: function(data){
            ...
            JSON.parse(data).forEach(function(currentVar) {
                $('#selectMap').append('<div data-map-id="'+currentVar.MAPCODE +'"><img alt="'+ currentVar.MAPNAME +'" src="testingpages/phaser/roadsafetygame/maps/'+ currentVar.MAPCODE +'.jpg"><div class="text"><p class="title">'+ currentVar.MAPNAME +'</p><p class="description">'+ currentVar.MAPDESC +'</p></div></div>');
            });
        },
